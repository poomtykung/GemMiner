...
WALLET_ADDRESS = os.getenv('WALLET_ADDRESS', 'DEFAULT_WELLET')
# change influra api key here or in .env
INFLURA_API_KEY = os.getenv('INFLURA_API_KEY', 'DEFAULT_INFLURA')
TARGET_GEM = int(os.getenv('TARGET_GEM', 'DEFAULT_GEM'))  # change gem here or in .env
...
# Line notification
NOTIFY_AUTH_TOKEN = os.getenv('NOTIFY_AUTH_TOKEN', 'DEFAULT_LINE_TOKEN')
